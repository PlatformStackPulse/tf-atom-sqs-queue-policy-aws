# tf-atom-sqs-queue-policy-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-sqs-queue-policy-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-sqs-queue-policy-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS SQS Queue Policy - attaches a resource-based policy to a queue.
...
|------|-------------|------|---------|:--------:|
| <a name="input_policy"></a> [policy](#input\_policy) | JSON policy document | `string` | n/a | yes |
| <a name="input_queue_url"></a> [queue\_url](#input\_queue\_url) | URL of the SQS queue | `string` | n/a | yes |
